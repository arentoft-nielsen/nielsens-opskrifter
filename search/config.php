...
$base_url = "http://www.arentoft-nielsen.dk/Opskrifter/";
...
$start_url = array(
"http://www.arentoft-nielsen.dk/Opskrifter/",
);

# Spider will index only files from these servers
$allow_url = array(
"http://www.arentoft-nielsen.dk/",
);
...
$file_ext = "html htm xml xhtml txt";
...
$use_stop_words = "YES";
$stop_words = "og er men kan har så hvis";
